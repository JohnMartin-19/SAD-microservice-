...
Microservices: Independent services build using Django(user-service, product-service,payment-service) with separate codebases and databases.
API-First Design: REST APIs with Django REST Framework, documented via OpenAPI (Swagger/ReDoc).
